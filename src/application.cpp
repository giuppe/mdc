...
void Application::stream_converter(AbstractConfiguration* config, std::string output_filename, std::string input_filename, std::string codec_name, Uint32 flows_number, Uint32 payload_size) {
