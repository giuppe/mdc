...
PcxStream::PcxStream() {m_data.resize(0);}
...
bool PcxStream::save_to_disk(const std::string& path) {
...
DataChunk& PcxStream::get_data(Uint64 offset, Uint64 size) 
{
...
Uint32 PcxStream::get_data_dim() const {return m_data.size();}
...
std::string PcxStream::get_stream_name() const {return m_stream_name;}
void PcxStream::update_stream_hash() {m_hash = "livent rulez";}
std::string PcxStream::get_stream_hash() const {return m_hash;}
PcxStream::~PcxStream() {}
